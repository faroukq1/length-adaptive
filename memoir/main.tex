...
\begin{figure}[htbp]
    ...
    \caption{$\Delta$NDCG@10 (Val $-$ Test) per epoch on ML-1M for all
             four hybrid models. The green band marks the healthy range
             ($\pm 0.01$). Red dots indicate epochs where the gap exceeds
             the threshold.}
    \label{fig:delta_1m}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption{$\Delta$NDCG@10 (Val $-$ Test) per epoch on ML-100K for all
             four hybrid models.}
...
\section*{Articles de conf\'{e}rences}
