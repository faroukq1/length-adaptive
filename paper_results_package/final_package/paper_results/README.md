...
- **Best Overall:** bert4rec (0.065240)
- **Best Baseline:** bert4rec (0.065240)
- **Best Hybrid:** hybrid_continuous (0.046786)
...
3. **Best Hybrid:** hybrid_continuous
   - NDCG@10: 0.046786
   - Improvement vs best baseline: -28.29%
...
5. **Convergence Speed:**
   - Average best epoch (all models): 61.9
   - Range: 1-113 epochs
